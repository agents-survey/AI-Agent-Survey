...
<div class="hero-section">
  ...
  <div class="partner-subbar">
    <p class="partner-label">Collaborating Institutions</p>
    <div class="institution-logos">
      <img src="{{ '/assets/images/logos/uc-berkeley-seal.png' | relative_url }}" alt="UC Berkeley" class="institution-logo" loading="lazy">
      <img src="{{ '/assets/images/logos/stanford-block-s.png' | relative_url }}" alt="Stanford University" class="institution-logo" loading="lazy">
